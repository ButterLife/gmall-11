package com.atguigu.admin.pms.controller;

import com.alibaba.dubbo.config.annotation.Reference;

import com.atguigu.admin.pms.vo.PmsProductCategoryParam;
...
public class PmsProductCategoryController {
    ...
    public Object listWithChildren() {
        //TODO 查询所有一级分类及子分类
        List<PmsProdectCategoryWithChildrentItern> pc = productCategoryService.getCatelogWithChilder(0);
        return new CommonResult().success(pc);
    }
}
